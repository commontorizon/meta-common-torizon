...
RDEPENDS:${PN}:append:class-target = " ${@'ostree-uboot-env' if '${PREFERRED_PROVIDER_u-boot-default-script}' and 'raspberrypi' not in '${MACHINE}' and 'nezha' not in '${MACHINE}' else ''}"
